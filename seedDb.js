  ...
  try {
    await Recipe.insertMany([
      ...
      },
      {
        ...
        description:
          'Remove the butter from the fridge and allow to soften.Preheat a griddle pan until really hot.Butter the rolls on both sides and grill on both sides until toasted and lightly charred (keep an eye on them so they don’t burn).Trim and dice the celery, chop the lobster meat and combine with the mayonnaise. Season with sea salt and black pepper to taste.Open your warm grilled buns, shred and pile the lettuce inside each one and top with the lobster mixture. Serve immediately.Source: https://www.jamieoliver.com/recipes/fruit-recipes/key-lime-pie/',
        email: 'hello@email.com',
        ingredients: [
          '85 g butter',
          '6 submarine rolls',
    ...
    console.log('yhi pr error hai', e);
  }
}
